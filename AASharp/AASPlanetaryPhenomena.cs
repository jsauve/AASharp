...
namespace AASharp
{
    public static class AASPlanetaryPhenomena
    {
        internal struct PlanetaryPhenomenaCoefficient1
        {
            ...
            public double M1 { get { return _M1; } }
        };
        ...
        private static PlanetaryPhenomenaCoefficient1[] g_PlanetaryPhenomenaCoefficient1 = 
{
  ...
  new PlanetaryPhenomenaCoefficient1( 2451569.379, 367.486703,  21.5569,  2.194998    ),
        ...
        public static double True(double k, PlanetaryObject planetaryObject, EventType type)
        {
            ...
            else if (planetaryObject == PlanetaryObject.SATURN)
            {
                a = AASCoordinateTransformation.MapTo0To360Range(82.74 + 40.76 * T);
                a = AASCoordinateTransformation.DegreesToRadians(a);
            ...
            else if (planetaryObject == PlanetaryObject.URANUS)
            {
            ...
            else if (planetaryObject == PlanetaryObject.NEPTUNE)
            {
                e = AASCoordinateTransformation.MapTo0To360Range(207.83 + 8.51 * T);
                e = AASCoordinateTransformation.DegreesToRadians(e);
            ...
            else if (planetaryObject == PlanetaryObject.VENUS)
            {
                if (type == EventType.INFERIOR_CONJUNCTION)
                {
            ...
            else if (planetaryObject == PlanetaryObject.MARS)
            {
            ...
            else if (planetaryObject == PlanetaryObject.JUPITER)
            {
                if (type == EventType.OPPOSITION)
                {

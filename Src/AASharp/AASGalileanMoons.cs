...
namespace AASharp
{
    public static class AASGalileanMoons
    {
        ...
        public static AASGalileanMoonsDetails Calculate(double JD)
        {
            ...
            AASGalileanMoonsDetails details1 = CalculateHelper(JD, sunlongrad, betarad, R);
            ...
            AASGalileanMoonsDetails details2 = CalculateHelper(JD + SunLightTravelTime - EarthLightTravelTime, sunlongrad, betarad, 0);
            ...
            details1Satellite1.bInEclipse = details2Satellite1.bInOccultation;
            details1Satellite2.bInEclipse = details2Satellite2.bInOccultation;
            details1Satellite3.bInEclipse = details2Satellite3.bInOccultation;
            details1Satellite4.bInEclipse = details2Satellite4.bInOccultation;
            details1Satellite1.bInShadowTransit = details2Satellite1.bInTransit;
            details1Satellite2.bInShadowTransit = details2Satellite2.bInTransit;
            details1Satellite3.bInShadowTransit = details2Satellite3.bInTransit;
            details1Satellite4.bInShadowTransit = details2Satellite4.bInTransit;

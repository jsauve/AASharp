...
namespace AASharp.Tests
{
    public class InterpolateTest
    {
        ...
        {
            yield return new object[] { 30, 6, new double[] { 29.43, 30.97, 27.69, 28.11, 31.58, 33.05 },
                                                new double[] { 0.4913598528, 0.5145891926, 0.4646875083, 0.4711658342, 0.5236885653, 0.5453707057 }, 0.50000000001805556 };
            yield return new object[] { 0, 6, new double[] { 29.43, 30.97, 27.69, 28.11, 31.58, 33.05 },
                                                new double[] { 0.4913598528, 0.5145891926, 0.4646875083, 0.4711658342, 0.5236885653, 0.5453707057 }, 5.1224662456661463E-05 };
            yield return new object[] { 90, 6, new double[] { 29.43, 30.97, 27.69, 28.11, 31.58, 33.05 },
                                                new double[] { 0.4913598528, 0.5145891926, 0.4646875083, 0.4711658342, 0.5236885653, 0.5453707057 }, 0.99996480997651815 };
        }
